...
@section('content')
        ...
        <div class="container">
            <div class="row align-items-center justify-content-between">
                <div class="col-lg-7 intro text-center">
                    <h1 class="text-white font-weight-bold mb-4" data-aos="fade-up" data-aos-delay="0">Profil DCC Bank</h1>
    ...
    <div class="site-section">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <img src="{{ asset('user/images/img_v_2-min.jpg') }}" alt="image" class="img-fluid rounded">
                </div>
    ...
    <div class="site-section slider-team-wrap bg-light">
        <div class="container">
            ...
            <div class="slider-team owl-carousel no-nav owl-3-slider">
                ...
                <div class="team">
                    <div class="pic">
                        <img src="{{ asset('user/images/person_3-min.jpg') }}" alt="Image" class="img-fluid">
                    </div>
    ...
    <div class="site-section overlay site-cover-2"
        style="background-image: url(&quot;{{ asset('user/images/img_v_3-min.jpg') }}&quot;)">
        <div class="container">
            <div class="row">
