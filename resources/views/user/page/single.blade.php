...
<div class="hero-slant overlay" data-stellar-background-ratio="0.5" style="background-image: url(&quot;{{ asset('user/images/hero-min.jpg') }}&quot;)">
      ...
      <div class="slant" style="background-image: url(&quot;{{ asset('user/images/slant-grey.svg') }}&quot;);"></div>
    </div>
          ...
          <div class="pt-5 categories_tags ">
            ...
            <div class="pt-5">
              ...
              <ul class="comment-list">
                <li class="comment">
                  <div class="vcard bio">
                    <img src="{{ asset('user/images/person_6-min.jpg') }}" alt="Image placeholder">
                  </div>
                ...
                <li class="comment">
                  <div class="vcard bio">
                    <img src="{{ asset('user/images/person_5-min.jpg') }}" alt="Image placeholder">
                  </div>
                  <div class="comment-body">
                  ...
                  <ul class="children">
                    <li class="comment">
                      <div class="vcard bio">
                        <img src="{{ asset('user/images/person_4-min.jpg') }}" alt="Image placeholder">
                      </div>
                      <div class="comment-body">
                        <h3>Chintan Patel</h3>
                        <div class="meta">January 9, 2018 at 2:21pm</div>
                      ...
                      <ul class="children">
                        <li class="comment">
                          <div class="vcard bio">
                            <img src="{{ asset('user/images/person_3-min.jpg') }}" alt="Image placeholder">
                          </div>
                          <div class="comment-body">
                            <h3>John Doe</h3>
                            <div class="meta">January 9, 2018 at 2:21pm</div>
                            ...
                            <ul class="children">
                              <li class="comment">
                                <div class="vcard bio">
                                  <img src="{{ asset('user/images/person_2-min.jpg') }}" alt="Image placeholder">
                                </div>
                                <div class="comment-body">
                                  <h3>Ben Afflick</h3>
                                  <div class="meta">January 9, 2018 at 2:21pm</div>
                ...
                <li class="comment">
                  <div class="vcard bio">
                    <img src="{{ asset('user/images/person_1-min.jpg') }}" alt="Image placeholder">
                  </div>
                  <div class="comment-body">
                    <h3>Jean Doe</h3>
                    <div class="meta">January 9, 2018 at 2:21pm</div>
        ...
        <div class="col-lg-3 mb-5 mb-lg-0 order-lg-3">
          ...
          <div class="mb-4">
            <a href="https://vimeo.com/342333493" data-fancybox class="video-wrap">
              ...
              <img src="{{ asset('user/images/img_h_5-min.jpg') }}" alt="Image" class="img-fluid rounded">
            </a>
          </div>  
