...
@section('title', 'Daftar Keunggulan')
...
@section('content')
<h4 class="py-3 mb-4"><span class="text-muted fw-light">Manajemen /</span> Daftar Keunggulan</h4>

<div class="card">
  <div class="card-header d-flex justify-content-between align-items-center">
    <h5 class="mb-0">Daftar Keunggulan</h5>
    <a href="{{ route('admin.benefits.create') }}" class="btn btn-primary"><i class="mdi mdi-plus me-1"></i> Tambah Data</a>
  </div>
          ...
          <td>
            <div class="dropdown">
              ...
              <div class="dropdown-menu">
                <a class="dropdown-item" href="{{ route('admin.benefits.edit', $benefit->id) }}"><i class="mdi mdi-pencil-outline me-1"></i> Edit</a>
                <button type="button" class="dropdown-item btn-delete" data-url="{{ route('admin.benefits.destroy', $benefit->id) }}">
