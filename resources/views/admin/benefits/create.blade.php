...
@section('content')
<h4 class="py-3 mb-4">
  <span class="text-muted fw-light">Manajemen / <a href="{{ route('admin.benefits.index') }}">Daftar Keunggulan</a> /</span> Tambah
</h4>

<div class="row">
  <div class="col-12">
    <div class="card mb-4">
      <h5 class="card-header">Form Tambah Keunggulan</h5>
      <div class="card-body">
        <form id="ajaxForm" action="{{ route('admin.benefits.store') }}" method="POST" enctype="multipart/form-data">
          @csrf
